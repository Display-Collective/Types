// http://bazaar.launchpad.net/~philho/+junk/Processing/files/242/ImageUpload
...
class DataUpload
{
  ...
  private static final String BASE_URL = "http://kennethfrederick.de/sandbox/display/mangata/";
  ...
  boolean UploadTextData(String fileName, String dataMimeType)
  {
    byte[] data;
    try {
      ...
      return UploadBinaryData(fileName, dataMimeType, data);
    }
    catch (Exception e)
    {
      e.printStackTrace();
