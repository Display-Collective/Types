...
function Setup() {
    // import svg
    svg = project.importSVG( document.getElementById('culaccino'), true );

    culaccino = new Group( svg.children );
    culaccino.position = view.center;
    ...
    spun = Spin( culaccino, {
        rings:   num,
        rotations: [
            parseInt(document.getElementById('angleSta').value),
            parseInt(document.getElementById('angleEnd').value)
        ],
